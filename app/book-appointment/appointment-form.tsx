...
export default function AppointmentForm() {
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setSuccess("Your appointment request has been submitted. We’ll confirm shortly.");
      ...
      <div className="grid gap-3">
        ...
        <div className="space-y-1">
          ...
          <Input
            name="truckType"
            required
            placeholder="e.g. Class 8 tractor, box truck, mixer"
          />
        </div>
        <div className="space-y-1">
          <label className="text-xs uppercase tracking-[0.18em] text-muted-foreground">
          ...
          <Input
            name="serviceNeeded"
            required
            placeholder="Engine, transmission, brakes, diagnostics, fleet PM, etc."
          />
        </div>
        <div className="space-y-1">
          <label className="text-xs uppercase tracking-[0.18em] text-muted-foreground">
        ...
        <div className="space-y-1">
          ...
          <Textarea
            name="message"
            required
            placeholder="Describe the symptoms, fault codes, or maintenance needs."
          />
        </div>
      </div>
      {success && (
